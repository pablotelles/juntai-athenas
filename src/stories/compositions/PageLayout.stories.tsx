...
import { LayoutDashboard, ShoppingBag, UtensilsCrossed, CreditCard, Settings, BarChart2 } from "lucide-react";
...
const navSections: NavSection[] = [
  ...
  },
  {
    title: "Relatórios",
    items: [
      { label: "Análises", href: "/reports", icon: BarChart2 },
    ],
  },
  {
    title: "Sistema",
    ...
    >
      ...
      <PageContent>
        <div className="grid gap-4">
          <p className="text-muted-foreground text-sm">Conteúdo da página aqui.</p>
        </div>
      </PageContent>
    </PageLayout>
  ),
